...
class VocabularyWord(models.Model):
    ...
    image_source = models.CharField(max_length=120, null=True, blank=True)
    image_attribution = models.CharField(max_length=300, null=True, blank=True)
    image_license = models.CharField(max_length=80, null=True, blank=True)
    image_approved = models.BooleanField(default=False)
    word_fact_text = models.TextField(null=True, blank=True)
    word_fact_type = models.CharField(max_length=32, null=True, blank=True)
    word_fact_confidence = models.FloatField(null=True, blank=True)
    word_fact_approved = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
